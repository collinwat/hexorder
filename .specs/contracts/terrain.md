...
> **Status: RETIRED as of M2.** Replaced by `game_system` contract (CellType, CellData, CellTypeRegistry, ActiveCellType). Code removed from `src/contracts/`. Kept for historical reference.
