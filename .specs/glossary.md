...
Canonical terminology for the Hexorder project. All agents, specs, and code must use these terms consistently.
...
| Tile vs. Cell | `HexTile` is the ECS marker component on the entity. "Cell" is the game design concept (type + properties). A hex tile entity *is* a cell once it has `CellData`. |
