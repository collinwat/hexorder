---
name: feature-lead
description: Decomposes features into specs, subtasks, and contracts. Use when planning a new feature or reviewing feature progress.
...
1. A complete spec at `.specs/features/<name>/spec.md` (use the template at `.specs/features/_template_spec.md`)
2. A fresh log at `.specs/features/<name>/log.md` (use the template at `.specs/features/_template_log.md`)
3. Any new contracts at `.specs/contracts/<name>.md` (use the template at `.specs/contracts/_template.md`)
