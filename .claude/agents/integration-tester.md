...
description: Tests cross-feature integration by building the full project and running all tests. Use after multiple features are implemented or when contracts change.
